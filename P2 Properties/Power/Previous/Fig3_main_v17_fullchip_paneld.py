...
def draw_panel_d(ax, df):
    ...
    for name in plot_order:
        ...
        bubble_ref = sub['bubble_size_w'] if 'bubble_size_w' in sub.columns else sub['full_chip_power_w']
    ...
    ax.text(0.02, 0.02, 'Marker size scales with full-chip/device power.', transform=ax.transAxes,
