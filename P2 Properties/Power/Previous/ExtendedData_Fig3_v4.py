...
def add_caption(fig):
    caption = ('Extended Data Fig. 3 | Microarchitectural explanation of Jetson overheads. '
...
def main():
    ...
    add_caption(fig)
    out_pdf = SCRIPT_DIR / 'ExtendedData_Fig3_v4.pdf'
    out_png = SCRIPT_DIR / 'ExtendedData_Fig3_v4.png'
