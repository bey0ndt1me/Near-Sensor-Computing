...
\textbf{f,} Representative depth maps reconstructed on-chip at successive stages of a single press into the elastomer (0.000--0.667\,s), illustrating the dense contact geometry recovered directly at the sensing interface. Depth colour scale: blue = 0\,mm, white = 1\,mm, red = 2\,mm.}
\label{fig:system}
\end{figure}
